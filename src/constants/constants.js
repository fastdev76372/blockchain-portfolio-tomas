export const projects = [
  {
  title: "DeFi Dapp Game: CrytoKnights ",
  description: "🔥Full Stack DeFi Dapp🔥Play decentralised chess on flowchain. A decentralized chess battle platform where players compete in real-time matches, leveraging blockchain technology and NFT rewards.",
    image: '/images/crypto-knights.png',
    tags: ['Solidity', 'Hardhat', 'Ethers.js', 'Next.js'],
  source: 'https://github.com/tomaswinner/crypto-checkmate',
  visit: 'https://crypto-checkmate.vercel.app/',
  id: 3,
},
  {
    ...
    source: 'https://github.com/tomaswinner/Diamond-NFT-Mini-Game',
...

  {
    ...
    description: "🔥Full Stack NFT Rental Marketplace🔥 NFT Owner can list their NFT for rent by specifying the name, description, rental duration, and rental price. Anyone can rent the NFT from the Rental Marketplace by paying the rental price [ No Collateral ]. During the rental duration, Renter will not be able to transfer the rented NFT to anyone. Upon expiry of rental duration, NFT is transferred from renter to NFT Owner.",
      ...
      tags: ['Solidity', 'Hardhat', 'Ethers.js', 'Next.js'],
    source: 'https://github.com/tomaswinner/NFT-Rental-Marketplace',
  ...
  
  {
    ...
    source: 'https://github.com/tomaswinner/DeFi-Yield-Farming',
...

  {
    ...
    tags: ['Solidity', 'Hardhat', 'Ethers.js', 'React'],
    source: 'https://github.com/tomaswinner/NFT-Ticketing-System-Frontend ',
